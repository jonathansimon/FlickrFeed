...
/**
 * An activity representing a single FlickrPhoto detail screen. This is all boilerplate to load an
 * activity with an internal fragment. As part of a master/detail paradigm, this is done do enable
 * split screen mode on tablet devices (which I removed from this app due to time constraints).
 */
public class FlickrPhotoDetailActivity extends AppCompatActivity {
